            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <button class="btn btn-primary" name="btn_artikel_baru" 
                        id="btn_artikel_baru" data-bs-toggle="modal" data-bs-target="#modalFormKategori">
                            Kategori Baru
                        </button>
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-warning" name="btn_ubah_kategori"
                                            data-bs-toggle="modal" data-bs-target="#modalFormUpdateKategori<?php echo $data_id_kategori; ?>">Ubah</button>
                                            <button class="btn btn-danger" name="btn_hapus_kategori" data-bs-toggle="modal" 
                                            data-bs-target="#modalHapusKategori<?php echo $data_id_kategori; ?>">Hapus</button>
                                        </td>
                                    </tr>
