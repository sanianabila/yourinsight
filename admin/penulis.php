            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <button class="btn btn-primary" name="btn_penulis_baru" 
                        id="btn_penulis_baru" data-bs-toggle="modal" data-bs-target="#modalFormPenulis">
                            Penulis Baru
                        </button>
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-warning" name="btn_ubah_penulis"
                                            data-bs-toggle="modal" data-bs-target="#modalFormUpdatePenulis<?php echo $data_id_penulis; ?>">Ubah</button>
                                            <button class="btn btn-danger" name="btn_hapus_penulis" data-bs-toggle="modal" 
                                            data-bs-target="#modalHapusPenulis<?php echo $data_id_penulis; ?>">Hapus</button>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        placeholder="isi dengan password lama/ganti dengan yang baru" name="password">
                                    </div>
